...
- Logo e dados: `src/config/brand.ts` (front). A API usa os mesmos textos em constantes **inline** em `server/seed-data.ts` (sem import cruzado `src`/`server`, compatível com a Vercel).
