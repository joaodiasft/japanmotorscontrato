...
/* -------------------------------------------------------------------------- */
/* Normalização de HTML dos modelos (inline: evita ERR_MODULE_NOT_FOUND na     */
/* Vercel com imports relativos a ficheiros fora do bundle).                  */
/* Mantenha em sincronia com `lib/contractTemplateHtml.ts` (frontend).        */
/* -------------------------------------------------------------------------- */
...
function normalizeContractTemplateHtml(raw: string): string {
